...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-08-2016 a las 19:27:22
...
CREATE TABLE `clientes` (
  ...
  `c_ape_nom` varchar(50) NOT NULL,
  `c_DNI` int(8) NOT NULL,
  `c_direccion` varchar(50) NOT NULL,
  `c_localidad` int(4) NOT NULL,
  `c_fnac` date NOT NULL,
  `c_categoria` int(2) NOT NULL,
...
CREATE TABLE `pedidos_cabecera` (
  `pedcab_id` int(10) NOT NULL,
  `pedcab_idcliente` int(10) NOT NULL,
  `pedcab_total` double NOT NULL,
  `pedcab_subtotal` double NOT NULL,
  `pedcab_banco` int(2) NOT NULL,
  `pedcab_fecha` date NOT NULL,
  `pedcab_tipo` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pedidos_detalles` (
  `peddet_id` int(10) NOT NULL,
  `peddet_idcab` int(10) NOT NULL,
  `peddet_idproducto` int(10) NOT NULL,
  `peddet_cantidad` int(2) NOT NULL,
  `peddet_total` double NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `prodcutos_cat`
--

CREATE TABLE `prodcutos_cat` (
  `pc_id` int(2) NOT NULL,
  `pc_nombre` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `productos` (
  ...
  `pro_categoria` int(2) NOT NULL,
  `pro_titulo` int(50) NOT NULL,
  `pro_detalle` varchar(1000) NOT NULL,
  `pro_imagen` varchar(50) NOT NULL,
  `pro_cantidad` int(3) NOT NULL,
  `pro_precio_compra` double NOT NULL,
  `pro_precio_venta` double NOT NULL,
  `pro_color` int(2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `productos_color`
--
...
--
-- Estructura de tabla para la tabla `productos_marca`
--

CREATE TABLE `productos_marca` (
  `pm_id` int(2) NOT NULL,
  `pm_nombre` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Estructura de tabla para la tabla `tipos_fact`
--

CREATE TABLE `tipos_fact` (
...
--
-- Indices de la tabla `clientes_cat`
--
ALTER TABLE `clientes_cat`
...
--
-- Indices de la tabla `prodcutos_cat`
--
ALTER TABLE `prodcutos_cat`
...
--
-- Indices de la tabla `productos_color`
--
ALTER TABLE `productos_color`
  ADD PRIMARY KEY (`pco_id`);

--
-- Indices de la tabla `productos_marca`
--
ALTER TABLE `productos_marca`
...
--
-- Indices de la tabla `tipos_fact`
--
ALTER TABLE `tipos_fact`
...
--
ALTER TABLE `pedidos_detalles`
  MODIFY `peddet_id` int(10) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `prodcutos_cat`
--
ALTER TABLE `prodcutos_cat`
  MODIFY `pc_id` int(2) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `productos_color`
--
ALTER TABLE `productos_color`
  MODIFY `pco_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `productos_marca`
--
ALTER TABLE `productos_marca`
  MODIFY `pm_id` int(2) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT de la tabla `tipos_fact`
--
ALTER TABLE `tipos_fact`
